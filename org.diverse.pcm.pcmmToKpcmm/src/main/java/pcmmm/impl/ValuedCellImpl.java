 ...
 * <ul>
 *   <li>{@link ValuedCellImpl#getInterpretation <em>Interpretation</em>}</li>
 *   <li>{@link ValuedCellImpl#getConcepts <em>Concepts</em>}</li>
 *   <li>{@link ValuedCellImpl#getMyHeaderProducts <em>My Header Products</em>}</li>
 *   <li>{@link ValuedCellImpl#getMyHeaderFeatures <em>My Header Features</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
