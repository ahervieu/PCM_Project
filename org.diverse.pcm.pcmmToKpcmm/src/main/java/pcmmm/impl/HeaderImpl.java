 ...
 * <ul>
 *   <li>{@link HeaderImpl#getConcept <em>Concept</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class HeaderImpl extends CellImpl implements Header {
	/**
	...
	protected EClass eStaticClass() {
		return PcmmmPackage.Literals.HEADER;
	}
		...
		if (concept != null && concept.eIsProxy()) {
			...
			if (concept != oldConcept) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PcmmmPackage.HEADER__CONCEPT, oldConcept, concept));
			}
		}
		return concept;
	}
	...
	public void setConcept(VariabilityConcept newConcept) {
		...
		concept = newConcept;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PcmmmPackage.HEADER__CONCEPT, oldConcept, concept));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PcmmmPackage.HEADER__CONCEPT:
