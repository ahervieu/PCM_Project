 ...
 * <ul>
 *   <li>{@link CellImpl#getName <em>Name</em>}</li>
 *   <li>{@link CellImpl#getVerbatim <em>Verbatim</em>}</li>
 *   <li>{@link CellImpl#getNote <em>Note</em>}</li>
 *   <li>{@link CellImpl#getLink <em>Link</em>}</li>
 *   <li>{@link CellImpl#getRow <em>Row</em>}</li>
 *   <li>{@link CellImpl#getRowspan <em>Rowspan</em>}</li>
 *   <li>{@link CellImpl#getColumn <em>Column</em>}</li>
 *   <li>{@link CellImpl#getColspan <em>Colspan</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
