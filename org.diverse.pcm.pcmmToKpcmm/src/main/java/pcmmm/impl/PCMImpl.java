 ...
 * <ul>
 *   <li>{@link PCMImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link PCMImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link PCMImpl#getMatrices <em>Matrices</em>}</li>
 *   <li>{@link PCMImpl#getName <em>Name</em>}</li>
 *   <li>{@link PCMImpl#getConcepts <em>Concepts</em>}</li>
 *   <li>{@link PCMImpl#getDomainCollection <em>Domain Collection</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
