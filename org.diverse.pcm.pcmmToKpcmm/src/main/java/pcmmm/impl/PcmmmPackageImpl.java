...
public class PcmmmPackageImpl extends EPackageImpl implements PcmmmPackage {
	 ...
	 * 
	 * <p>This method is used to initialize {@link pcmmm.PcmmmPackage#eINSTANCE} when that field is accessed.
	...
	public static PcmmmPackage init() {
		if (isInited) return (PcmmmPackage) Registry.INSTANCE.getEPackage(PcmmmPackage.eNS_URI);

		// Obtain or create and register package
		PcmmmPackageImpl thePcmmmPackage = (PcmmmPackageImpl)(Registry.INSTANCE.get(eNS_URI) instanceof PcmmmPackageImpl ? Registry.INSTANCE.get(eNS_URI) : new PcmmmPackageImpl());
		...
		Registry.INSTANCE.put(PcmmmPackage.eNS_URI, thePcmmmPackage);
