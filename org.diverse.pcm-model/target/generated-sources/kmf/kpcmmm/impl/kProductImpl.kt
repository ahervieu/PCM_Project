 ...
 */
class kProductImpl : kpcmmm.container.KMFContainerPersistenceImpl, kpcmmm.kProduct { 
...
override public fun withName(p : String) : kpcmmm.kProduct{
name=p;
return this;
}
...
override public fun withGenerated_KMF_ID(p : String) : kpcmmm.kProduct{
generated_KMF_ID=p;
return this;
}
...
override fun addMyValuedCells(myValuedCellsP : kpcmmm.kValuedCell) : kpcmmm.kProduct{
internal_addMyValuedCells(myValuedCellsP, true, true)
return this;
}

override fun addAllMyValuedCells(myValuedCellsP :List<kpcmmm.kValuedCell>) : kpcmmm.kProduct{
...
override fun removeMyValuedCells(myValuedCellsP : kpcmmm.kValuedCell) : kpcmmm.kProduct{
internal_removeMyValuedCells(myValuedCellsP, true, true)
return this;
}

override fun removeAllMyValuedCells() : kpcmmm.kProduct{
...
override fun addConstraints(constraintsP : kpcmmm.kValuedCell) : kpcmmm.kProduct{
internal_addConstraints(constraintsP, true, true)
return this;
}

override fun addAllConstraints(constraintsP :List<kpcmmm.kValuedCell>) : kpcmmm.kProduct{
...
override fun removeConstraints(constraintsP : kpcmmm.kValuedCell) : kpcmmm.kProduct{
internal_removeConstraints(constraintsP, true, true)
return this;
}

override fun removeAllConstraints() : kpcmmm.kProduct{
...
return kpcmmm.util.Constants.kpcmmm_kProduct;
}
}
