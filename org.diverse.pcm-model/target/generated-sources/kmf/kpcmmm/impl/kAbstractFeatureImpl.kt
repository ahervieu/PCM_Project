 ...
 */
class kAbstractFeatureImpl : kpcmmm.container.KMFContainerImpl, kpcmmm.kAbstractFeature { 
...
override public fun withName(p : String) : kpcmmm.kAbstractFeature{
name=p;
return this;
}
...
override public fun withGenerated_KMF_ID(p : String) : kpcmmm.kAbstractFeature{
generated_KMF_ID=p;
return this;
}
...
(el as kpcmmm.container.KMFContainerImpl).reflexiveMutator(org.kevoree.modeling.api.util.ActionType.SET, kpcmmm.util.Constants.Ref_myHeaderFeatures, this, false, fireEvents)
}
if(fireEvents) {
...
override fun addMyValuedCells(myValuedCellsP : kpcmmm.kValuedCell) : kpcmmm.kAbstractFeature{
internal_addMyValuedCells(myValuedCellsP, true, true)
return this;
}

override fun addAllMyValuedCells(myValuedCellsP :List<kpcmmm.kValuedCell>) : kpcmmm.kAbstractFeature{
...
override fun removeMyValuedCells(myValuedCellsP : kpcmmm.kValuedCell) : kpcmmm.kAbstractFeature{
internal_removeMyValuedCells(myValuedCellsP, true, true)
return this;
}

override fun removeAllMyValuedCells() : kpcmmm.kAbstractFeature{
...
(el as kpcmmm.container.KMFContainerImpl).reflexiveMutator(org.kevoree.modeling.api.util.ActionType.SET, kpcmmm.util.Constants.Ref_myHeaderFeatures, null, false, fireEvents)
}
}
...
override fun addConstraints(constraintsP : kpcmmm.kValuedCell) : kpcmmm.kAbstractFeature{
internal_addConstraints(constraintsP, true, true)
return this;
}

override fun addAllConstraints(constraintsP :List<kpcmmm.kValuedCell>) : kpcmmm.kAbstractFeature{
...
override fun removeConstraints(constraintsP : kpcmmm.kValuedCell) : kpcmmm.kAbstractFeature{
internal_removeConstraints(constraintsP, true, true)
return this;
}

override fun removeAllConstraints() : kpcmmm.kAbstractFeature{
...
return kpcmmm.util.Constants.kpcmmm_kAbstractFeature;
}
}
