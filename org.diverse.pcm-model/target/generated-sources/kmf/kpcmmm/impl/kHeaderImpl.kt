 ...
 */
class kHeaderImpl : kpcmmm.container.KMFContainerPersistenceImpl, kpcmmm.kHeader { 
...
override public fun withName(p : String) : kpcmmm.kHeader{
name=p;
return this;
}
...
override public fun withVerbatim(p : String) : kpcmmm.kHeader{
verbatim=p;
return this;
}
...
override public fun withNote(p : List<String>) : kpcmmm.kHeader{
note=p;
return this;
}
...
override public fun withLink(p : List<String>) : kpcmmm.kHeader{
link=p;
return this;
}
...
override public fun withRow(p : Int) : kpcmmm.kHeader{
row=p;
return this;
}
...
override public fun withRowspan(p : Int) : kpcmmm.kHeader{
rowspan=p;
return this;
}
...
override public fun withColumn(p : Int) : kpcmmm.kHeader{
column=p;
return this;
}
...
override public fun withColspan(p : Int) : kpcmmm.kHeader{
colspan=p;
return this;
}
...
override public fun withGenerated_KMF_ID(p : String) : kpcmmm.kHeader{
generated_KMF_ID=p;
return this;
}
...
if(conceptP != null) {
(conceptP!! as kpcmmm.container.KMFContainerPersistenceImpl).addInboundReference(this, kpcmmm.util.Constants.Ref_concept)
} else {
if($concept != null) {
($concept!! as kpcmmm.container.KMFContainerPersistenceImpl).removeInboundReference(this, kpcmmm.util.Constants.Ref_concept)
}
}
$concept = conceptP
if(fireEvents) {
...
override public fun withConcept(ref : kpcmmm.kVariabilityConcept) : kpcmmm.kHeader{
return this;
}
...
this.internal_row((value as? Int), fireEvents)
}
kpcmmm.util.Constants.Att_rowspan -> {
this.internal_rowspan((value as? Int), fireEvents)
}
kpcmmm.util.Constants.Att_column -> {
this.internal_column((value as? Int), fireEvents)
}
kpcmmm.util.Constants.Att_colspan -> {
this.internal_colspan((value as? Int), fireEvents)
}
...
return kpcmmm.util.Constants.kpcmmm_kHeader;
}
}
