 ...
 */
class kFeatureImpl : kpcmmm.container.KMFContainerImpl, kpcmmm.kFeature { 
...
if(domain != null) {
(domain!! as kpcmmm.container.KMFContainerImpl).removeInboundReference(this,kpcmmm.util.Constants.Ref_domain)
domain = null
}
...
if(domainP != null) {
(domainP!! as kpcmmm.container.KMFContainerImpl).addInboundReference(this, kpcmmm.util.Constants.Ref_domain)
} else {
if($domain != null) {
($domain!! as kpcmmm.container.KMFContainerImpl).removeInboundReference(this, kpcmmm.util.Constants.Ref_domain)
}
