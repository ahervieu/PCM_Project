 ...
 */
class kInconsistentImpl : kpcmmm.container.KMFContainerPersistenceImpl, kpcmmm.kInconsistent { 
...
override public fun withName(p : String) : kpcmmm.kInconsistent{
name=p;
return this;
}
...
override public fun withConfident(p : Boolean) : kpcmmm.kInconsistent{
confident=p;
return this;
}
...
override public fun withVerbatim(p : String) : kpcmmm.kInconsistent{
verbatim=p;
return this;
}
...
override public fun withGenerated_KMF_ID(p : String) : kpcmmm.kInconsistent{
generated_KMF_ID=p;
return this;
}
...
return kpcmmm.util.Constants.kpcmmm_kInconsistent;
}
}
