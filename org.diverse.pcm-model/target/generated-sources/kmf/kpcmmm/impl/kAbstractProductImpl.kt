...
override public fun withName(p : String) : kpcmmm.kAbstractProduct{
name=p;
return this;
}
...
override public fun withGenerated_KMF_ID(p : String) : kpcmmm.kAbstractProduct{
generated_KMF_ID=p;
return this;
}
...
override fun addMyValuedCells(myValuedCellsP : kpcmmm.kValuedCell) : kpcmmm.kAbstractProduct{
internal_addMyValuedCells(myValuedCellsP, true, true)
return this;
}

override fun addAllMyValuedCells(myValuedCellsP :List<kpcmmm.kValuedCell>) : kpcmmm.kAbstractProduct{
...
override fun removeMyValuedCells(myValuedCellsP : kpcmmm.kValuedCell) : kpcmmm.kAbstractProduct{
internal_removeMyValuedCells(myValuedCellsP, true, true)
return this;
}

override fun removeAllMyValuedCells() : kpcmmm.kAbstractProduct{
...
override fun addConstraints(constraintsP : kpcmmm.kValuedCell) : kpcmmm.kAbstractProduct{
internal_addConstraints(constraintsP, true, true)
return this;
}

override fun addAllConstraints(constraintsP :List<kpcmmm.kValuedCell>) : kpcmmm.kAbstractProduct{
...
override fun removeConstraints(constraintsP : kpcmmm.kValuedCell) : kpcmmm.kAbstractProduct{
internal_removeConstraints(constraintsP, true, true)
return this;
}

override fun removeAllConstraints() : kpcmmm.kAbstractProduct{
...
return kpcmmm.util.Constants.kpcmmm_kAbstractProduct;
}
}
