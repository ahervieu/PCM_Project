 ...
 */
class kXOrImpl : kpcmmm.container.KMFContainerImpl, kpcmmm.kXOr { 
...
override public fun withName(p : String) : kpcmmm.kXOr{
name=p;
return this;
}
...
override public fun withConfident(p : Boolean) : kpcmmm.kXOr{
confident=p;
return this;
}
...
override public fun withVerbatim(p : String) : kpcmmm.kXOr{
verbatim=p;
return this;
}
...
override public fun withGenerated_KMF_ID(p : String) : kpcmmm.kXOr{
generated_KMF_ID=p;
return this;
}
...
override fun addContraints(contraintsP : kpcmmm.kConstraint) : kpcmmm.kXOr{
internal_addContraints(contraintsP, true, true)
return this;
}

override fun addAllContraints(contraintsP :List<kpcmmm.kConstraint>) : kpcmmm.kXOr{
...
override fun removeContraints(contraintsP : kpcmmm.kConstraint) : kpcmmm.kXOr{
...
override fun removeAllContraints() : kpcmmm.kXOr{
...
return kpcmmm.util.Constants.kpcmmm_kXOr;
}
}
