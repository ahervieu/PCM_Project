 ...
 */
class kProductFamilyImpl : kpcmmm.container.KMFContainerPersistenceImpl, kpcmmm.kProductFamily { 
...
(el as kpcmmm.container.KMFContainerPersistenceImpl).addInboundReference(this, kpcmmm.util.Constants.Ref_products)
(el as kpcmmm.container.KMFContainerPersistenceImpl).setEContainer(this,kpcmmm.container.RemoveFromContainerCommand(this, org.kevoree.modeling.api.util.ActionType.REMOVE, kpcmmm.util.Constants.Ref_products, el),kpcmmm.util.Constants.Ref_products)
}
if(fireEvents) {
...
(productsP as kpcmmm.container.KMFContainerPersistenceImpl).setEContainer(this,kpcmmm.container.RemoveFromContainerCommand(this, org.kevoree.modeling.api.util.ActionType.REMOVE, kpcmmm.util.Constants.Ref_products, productsP),kpcmmm.util.Constants.Ref_products)
(productsP as kpcmmm.container.KMFContainerPersistenceImpl).addInboundReference(this, kpcmmm.util.Constants.Ref_products)
}
}
...
(productsP as kpcmmm.container.KMFContainerPersistenceImpl).removeInboundReference(this, kpcmmm.util.Constants.Ref_products)
(productsP!! as kpcmmm.container.KMFContainerPersistenceImpl).setEContainer(null,null,null)
...
val resolved = _products.get(key)
if(resolved==null){
val result = relativeLookupFrom(this,kpcmmm.util.Constants.Ref_products,key)
return result as? kpcmmm.kAbstractProduct
} else {
return resolved
}
}
