 ...
 */
class kBooleanImpl : kpcmmm.container.KMFContainerPersistenceImpl, kpcmmm.kBoolean { 
...
override public fun withName(p : String) : kpcmmm.kBoolean{
name=p;
return this;
}
...
override public fun withConfident(p : Boolean) : kpcmmm.kBoolean{
confident=p;
return this;
}
...
override public fun withVerbatim(p : String) : kpcmmm.kBoolean{
verbatim=p;
return this;
}
...
override public fun withGenerated_KMF_ID(p : String) : kpcmmm.kBoolean{
generated_KMF_ID=p;
return this;
}
...
override public fun withValue(p : Boolean) : kpcmmm.kBoolean{
value=p;
return this;
}
public override var value : Boolean? = kpcmmm.util.Constants.BOOLEAN_DEFAULTVAL
	 set(iP : Boolean?){
checkLazyLoad()
...
return $value
	...
	private fun internal_value(iP : Boolean?, fireEvents : Boolean = true){
if(isReadOnly()){throw Exception(kpcmmm.util.Constants.READ_ONLY_EXCEPTION)}
if(iP != value){
val oldPath = path()
val kmf_previousVal = $value
$value = iP
if(!inResolution){
if(fireEvents) {
fireModelEvent(org.kevoree.modeling.api.events.ModelEvent(org.kevoree.modeling.api.util.ActionType.SET, org.kevoree.modeling.api.util.ElementAttributeType.ATTRIBUTE, kpcmmm.util.Constants.Att_value, value,kmf_previousVal,this,oldPath))
}
}
	}
	}//end of setter
...
kpcmmm.util.Constants.Att_value -> {
this.internal_value((value.toString().toBoolean()), fireEvents)
}
