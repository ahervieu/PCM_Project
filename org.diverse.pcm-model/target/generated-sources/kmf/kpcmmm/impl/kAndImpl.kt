 ...
 */
class kAndImpl : kpcmmm.container.KMFContainerImpl, kpcmmm.kAnd { 
...
override public fun withName(p : String) : kpcmmm.kAnd{
name=p;
return this;
}
...
override public fun withConfident(p : Boolean) : kpcmmm.kAnd{
confident=p;
return this;
}
...
override public fun withVerbatim(p : String) : kpcmmm.kAnd{
verbatim=p;
return this;
}
...
override public fun withGenerated_KMF_ID(p : String) : kpcmmm.kAnd{
generated_KMF_ID=p;
return this;
}
...
override fun addContraints(contraintsP : kpcmmm.kConstraint) : kpcmmm.kAnd{
internal_addContraints(contraintsP, true, true)
return this;
}

override fun addAllContraints(contraintsP :List<kpcmmm.kConstraint>) : kpcmmm.kAnd{
...
override fun removeContraints(contraintsP : kpcmmm.kConstraint) : kpcmmm.kAnd{
...
override fun removeAllContraints() : kpcmmm.kAnd{
...
return kpcmmm.util.Constants.kpcmmm_kAnd;
}
}
