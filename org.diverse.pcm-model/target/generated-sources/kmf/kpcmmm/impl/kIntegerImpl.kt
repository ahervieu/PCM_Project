 ...
 */
class kIntegerImpl : kpcmmm.container.KMFContainerPersistenceImpl, kpcmmm.kInteger { 
...
override public fun withName(p : String) : kpcmmm.kInteger{
name=p;
return this;
}
...
override public fun withConfident(p : Boolean) : kpcmmm.kInteger{
confident=p;
return this;
}
...
override public fun withVerbatim(p : String) : kpcmmm.kInteger{
verbatim=p;
return this;
}
...
override public fun withGenerated_KMF_ID(p : String) : kpcmmm.kInteger{
generated_KMF_ID=p;
return this;
}
...
override public fun withValue(p : Int) : kpcmmm.kInteger{
value=p;
return this;
}
public override var value : Int? = kpcmmm.util.Constants.INT_DEFAULTVAL
	 set(iP : Int?){
checkLazyLoad()
...
return $value
	...
	private fun internal_value(iP : Int?, fireEvents : Boolean = true){
if(isReadOnly()){throw Exception(kpcmmm.util.Constants.READ_ONLY_EXCEPTION)}
if(iP != value){
val oldPath = path()
...
this.internal_value((value.toString().toInt()), fireEvents)
}
...
return kpcmmm.util.Constants.kpcmmm_kInteger;
}
}
