 ...
 */
class kPCMImpl : kpcmmm.container.KMFContainerImpl, kpcmmm.kPCM { 
...
(domainCollection!! as kpcmmm.container.KMFContainerImpl).removeInboundReference(this,kpcmmm.util.Constants.Ref_domainCollection)
...
(el as kpcmmm.container.KMFContainerImpl).addInboundReference(this, kpcmmm.util.Constants.Ref_concepts)
(el as kpcmmm.container.KMFContainerImpl).setEContainer(this,kpcmmm.container.RemoveFromContainerCommand(this, org.kevoree.modeling.api.util.ActionType.REMOVE, kpcmmm.util.Constants.Ref_concepts, el),kpcmmm.util.Constants.Ref_concepts)
}
if(fireEvents) {
...
(conceptsP as kpcmmm.container.KMFContainerImpl).setEContainer(this,kpcmmm.container.RemoveFromContainerCommand(this, org.kevoree.modeling.api.util.ActionType.REMOVE, kpcmmm.util.Constants.Ref_concepts, conceptsP),kpcmmm.util.Constants.Ref_concepts)
(conceptsP as kpcmmm.container.KMFContainerImpl).addInboundReference(this, kpcmmm.util.Constants.Ref_concepts)
}
}
...
(conceptsP as kpcmmm.container.KMFContainerImpl).removeInboundReference(this, kpcmmm.util.Constants.Ref_concepts)
(conceptsP!! as kpcmmm.container.KMFContainerImpl).setEContainer(null,null,null)
...
if($domainCollection != null){
($domainCollection!! as kpcmmm.container.KMFContainerImpl ).setEContainer(null, null,null)
}
if(domainCollectionP!=null){
(domainCollectionP as kpcmmm.container.KMFContainerImpl).setEContainer(this, kpcmmm.container.RemoveFromContainerCommand(this, org.kevoree.modeling.api.util.ActionType.SET, kpcmmm.util.Constants.Ref_domainCollection, null),kpcmmm.util.Constants.Ref_domainCollection)
}
val kmf_previousVal = $domainCollection
if(domainCollectionP != null) {
(domainCollectionP!! as kpcmmm.container.KMFContainerImpl).addInboundReference(this, kpcmmm.util.Constants.Ref_domainCollection)
} else {
if($domainCollection != null) {
($domainCollection!! as kpcmmm.container.KMFContainerImpl).removeInboundReference(this, kpcmmm.util.Constants.Ref_domainCollection)
}
...
(el as kpcmmm.container.KMFContainerImpl).addInboundReference(this, kpcmmm.util.Constants.Ref_matrices)
(el as kpcmmm.container.KMFContainerImpl).setEContainer(this,kpcmmm.container.RemoveFromContainerCommand(this, org.kevoree.modeling.api.util.ActionType.REMOVE, kpcmmm.util.Constants.Ref_matrices, el),kpcmmm.util.Constants.Ref_matrices)
}
if(fireEvents) {
...
(matricesP as kpcmmm.container.KMFContainerImpl).setEContainer(this,kpcmmm.container.RemoveFromContainerCommand(this, org.kevoree.modeling.api.util.ActionType.REMOVE, kpcmmm.util.Constants.Ref_matrices, matricesP),kpcmmm.util.Constants.Ref_matrices)
(matricesP as kpcmmm.container.KMFContainerImpl).addInboundReference(this, kpcmmm.util.Constants.Ref_matrices)
}
}
...
(matricesP as kpcmmm.container.KMFContainerImpl).removeInboundReference(this, kpcmmm.util.Constants.Ref_matrices)
(matricesP!! as kpcmmm.container.KMFContainerImpl).setEContainer(null,null,null)
