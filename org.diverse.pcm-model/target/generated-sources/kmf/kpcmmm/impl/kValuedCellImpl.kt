 ...
 */
class kValuedCellImpl : kpcmmm.container.KMFContainerImpl, kpcmmm.kValuedCell { 
...
(interpretation!! as kpcmmm.container.KMFContainerImpl).removeInboundReference(this,kpcmmm.util.Constants.Ref_interpretation)
interpretation = null
}
removeAllConcepts()
if(myHeaderProducts != null) {
(myHeaderProducts!! as kpcmmm.container.KMFContainerImpl).removeInboundReference(this,kpcmmm.util.Constants.Ref_myHeaderProducts)
myHeaderProducts = null
}
if(myHeaderFeatures != null) {
(myHeaderFeatures!! as kpcmmm.container.KMFContainerImpl).removeInboundReference(this,kpcmmm.util.Constants.Ref_myHeaderFeatures)
myHeaderFeatures = null
}
...
(el as kpcmmm.container.KMFContainerImpl).reflexiveMutator(org.kevoree.modeling.api.util.ActionType.ADD, kpcmmm.util.Constants.Ref_constraints, this, false, fireEvents)
}
if(fireEvents) {
...
if(setOpposite){
for(el in temp_els!!){
(el as kpcmmm.container.KMFContainerImpl).removeInboundReference(this, kpcmmm.util.Constants.Ref_concepts)
(el as kpcmmm.container.KMFContainerImpl).reflexiveMutator(org.kevoree.modeling.api.util.ActionType.REMOVE, kpcmmm.util.Constants.Ref_constraints, this, false, fireEvents)
}
}
_concepts.clear()
if(fireEvents){
...
if(myHeaderFeaturesP != null) {
(myHeaderFeaturesP!! as kpcmmm.container.KMFContainerImpl).addInboundReference(this, kpcmmm.util.Constants.Ref_myHeaderFeatures)
} else {
if($myHeaderFeatures != null) {
($myHeaderFeatures!! as kpcmmm.container.KMFContainerImpl).removeInboundReference(this, kpcmmm.util.Constants.Ref_myHeaderFeatures)
}
...
if($interpretation != null){
($interpretation!! as kpcmmm.container.KMFContainerImpl ).setEContainer(null, null,null)
}
if(interpretationP!=null){
(interpretationP as kpcmmm.container.KMFContainerImpl).setEContainer(this, kpcmmm.container.RemoveFromContainerCommand(this, org.kevoree.modeling.api.util.ActionType.SET, kpcmmm.util.Constants.Ref_interpretation, null),kpcmmm.util.Constants.Ref_interpretation)
}
val kmf_previousVal = $interpretation
if(interpretationP != null) {
(interpretationP!! as kpcmmm.container.KMFContainerImpl).addInboundReference(this, kpcmmm.util.Constants.Ref_interpretation)
} else {
if($interpretation != null) {
($interpretation!! as kpcmmm.container.KMFContainerImpl).removeInboundReference(this, kpcmmm.util.Constants.Ref_interpretation)
}
...
if(myHeaderProductsP != null) {
(myHeaderProductsP!! as kpcmmm.container.KMFContainerImpl).addInboundReference(this, kpcmmm.util.Constants.Ref_myHeaderProducts)
} else {
if($myHeaderProducts != null) {
($myHeaderProducts!! as kpcmmm.container.KMFContainerImpl).removeInboundReference(this, kpcmmm.util.Constants.Ref_myHeaderProducts)
}
