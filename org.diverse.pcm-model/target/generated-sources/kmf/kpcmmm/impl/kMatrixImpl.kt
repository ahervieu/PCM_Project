 ...
 */
class kMatrixImpl : kpcmmm.container.KMFContainerPersistenceImpl, kpcmmm.kMatrix { 
...
_cells.put(elKey!!,el)
(el as kpcmmm.container.KMFContainerPersistenceImpl).addInboundReference(this, kpcmmm.util.Constants.Ref_cells)
(el as kpcmmm.container.KMFContainerPersistenceImpl).setEContainer(this,kpcmmm.container.RemoveFromContainerCommand(this, org.kevoree.modeling.api.util.ActionType.REMOVE, kpcmmm.util.Constants.Ref_cells, el),kpcmmm.util.Constants.Ref_cells)
}
if(fireEvents) {
...
(cellsP as kpcmmm.container.KMFContainerPersistenceImpl).setEContainer(this,kpcmmm.container.RemoveFromContainerCommand(this, org.kevoree.modeling.api.util.ActionType.REMOVE, kpcmmm.util.Constants.Ref_cells, cellsP),kpcmmm.util.Constants.Ref_cells)
(cellsP as kpcmmm.container.KMFContainerPersistenceImpl).addInboundReference(this, kpcmmm.util.Constants.Ref_cells)
}
}
...
(cellsP as kpcmmm.container.KMFContainerPersistenceImpl).removeInboundReference(this, kpcmmm.util.Constants.Ref_cells)
(cellsP!! as kpcmmm.container.KMFContainerPersistenceImpl).setEContainer(null,null,null)
...
val resolved = _cells.get(key)
if(resolved==null){
val result = relativeLookupFrom(this,kpcmmm.util.Constants.Ref_cells,key)
return result as? kpcmmm.kCell
} else {
return resolved
}
}
