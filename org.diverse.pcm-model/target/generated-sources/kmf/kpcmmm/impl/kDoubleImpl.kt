 ...
 */
class kDoubleImpl : kpcmmm.container.KMFContainerPersistenceImpl, kpcmmm.kDouble { 
...
override public fun withName(p : String) : kpcmmm.kDouble{
name=p;
return this;
}
...
override public fun withConfident(p : Boolean) : kpcmmm.kDouble{
confident=p;
return this;
}
...
override public fun withVerbatim(p : String) : kpcmmm.kDouble{
verbatim=p;
return this;
}
...
override public fun withGenerated_KMF_ID(p : String) : kpcmmm.kDouble{
generated_KMF_ID=p;
return this;
}
...
override public fun withValue(p : Double) : kpcmmm.kDouble{
value=p;
return this;
}
public override var value : Double? = kpcmmm.util.Constants.DOUBLE_DEFAULTVAL
	 set(iP : Double?){
checkLazyLoad()
...
return $value
	...
	private fun internal_value(iP : Double?, fireEvents : Boolean = true){
if(isReadOnly()){throw Exception(kpcmmm.util.Constants.READ_ONLY_EXCEPTION)}
if(iP != value){
val oldPath = path()
...
this.internal_value((value.toString().toDouble()), fireEvents)
}
...
return kpcmmm.util.Constants.kpcmmm_kDouble;
}
}
